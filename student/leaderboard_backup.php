...
$stmt = $pdo->prepare("
    SELECT DISTINCT s.id, s.section_name as name, s.year_level as year
    FROM sections s
                                        ...
                                        <?php if ($current_user): ?>
                                            ...
                                            <small class="text-muted">
                                                ...
                                                <?php if ($current_user['section_name'] && $current_user['section_year']): ?>
                                                    • <?php echo formatSectionName(['year' => $current_user['section_year'], 'name' => $current_user['section_name']]); ?>
                                                <?php endif; ?>
                                            </small>
                                        <?php else: ?>
                                        ...
                                        <div class="podium-row">
                                            ...
                                            <div class="podium-item podium-2nd">
                                                ...
                                                <?php if ($student_2nd && $student_2nd['section_name'] && $student_2nd['section_year']): ?>
                                                    <div class="podium-section"><?php echo formatSectionName(['year' => $student_2nd['section_year'], 'name' => $student_2nd['section_name']]); ?></div>
                                                <?php endif; ?>
                                            ...
                                            <div class="podium-item podium-1st">
                                                ...
                                                <?php if ($student_1st && $student_1st['section_name'] && $student_1st['section_year']): ?>
                                                    <div class="podium-section"><?php echo formatSectionName(['year' => $student_1st['section_year'], 'name' => $student_1st['section_name']]); ?></div>
                                                <?php endif; ?>
                                            ...
                                            <div class="podium-item podium-3rd">
                                                ...
                                                <?php if ($student_3rd && $student_3rd['section_name'] && $student_3rd['section_year']): ?>
                                                    <div class="podium-section"><?php echo formatSectionName(['year' => $student_3rd['section_year'], 'name' => $student_3rd['section_name']]); ?></div>
                                                <?php endif; ?>
