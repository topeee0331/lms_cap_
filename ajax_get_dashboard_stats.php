...
function getTeacherStats($pdo, $teacher_id, $academic_period_id) {
    ...
    $year_condition_sections = $academic_period_id ? "AND s.academic_period_id = ?" : "";
    $params = $academic_period_id ? [$teacher_id, $academic_period_id, $academic_period_id, $teacher_id, $academic_period_id] : [$teacher_id, $teacher_id];
    ...
    $stmt = $pdo->prepare("
        SELECT 
            ...
            (
                ...
                WHERE c2.teacher_id = ? AND c2.academic_period_id = ? $year_condition_sections
